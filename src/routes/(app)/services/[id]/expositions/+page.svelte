<script lang="ts">
	...
	import { collectMcpUrlsFromActiveExpositions } from '$lib/mcpEndpointUrls';
	import { expositionBelongsToService } from '$lib/serviceHub';
	import { SERVICE_CONTEXT_KEY, type ServiceContextValue } from '$lib/serviceContext';
